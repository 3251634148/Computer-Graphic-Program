...
void init()
{
	...
	// 设置物体的旋转位移
	table->setTranslation(glm::vec3(0.0, 0.2, -0.05));
	...
	// 设置物体的旋转位移
	wawa->setTranslation(glm::vec3(0.0, -0.3, 0.0));
...
int main(int argc, char** argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, "2022150153-lcx-exp4", NULL, NULL);
	if (window == NULL)
	{
