...
void init()
{
	...
	// 设置材质
	mesh->setAmbient(glm::vec4(0.1745f, 0.01175, 0.01175, 1.0)); // 环境光
	mesh->setDiffuse(glm::vec4(0.61424f, 0.04136f, 0.04136f, 1.0)); // 漫反射
	mesh->setSpecular(glm::vec4(0.727811f, 0.626959f, 0.626959f, 1.0)); // 镜面反射
	mesh->setShininess(0.6); //高光系数
...
void display()
{
	...
	// 将着色器 isShadow 设置为1，表示正常绘制的颜色，如果是1着表示阴影
...
int main(int argc, char **argv)
{
	...
	GLFWwindow* mainwindow = glfwCreateWindow(600, 600, "2022150153_lcx_实验3", NULL, NULL);
	if (mainwindow == NULL)
	{
